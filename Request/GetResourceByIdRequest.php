 ...
 * for fetching properties of the request, shown as "getId".
 *
 * Using an getOptions() method should be considered faux pas, in that the aim of this bundle is to structure the request.
